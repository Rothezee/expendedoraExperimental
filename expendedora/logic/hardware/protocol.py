"""
Protocolo line-delimited JSON entre PC y Arduino (115200 baud).
...
def cmd_test_dispense() -> Dict[str, Any]:
    return {"dir": "cmd", "type": "TEST_DISPENSE"}
...
def hopper_from_tolva(tolva: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "motor_pin": int(tolva.get("motor_pin", 10)),
        ...
        "sensor_blocked_high": bool(tolva.get("sensor_blocked_high", True)),
...
def destrabe_from_config(cfg: Dict[str, Any], tolva: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "max_intentos": int(per.get("max_intentos", base.get("max_intentos", 3))),
