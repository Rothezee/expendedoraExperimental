"""HTTP remoto: heartbeat y telemetría de venta (puente al backend)."""
...
class TelemetryRepository:
    ...
    def _build_targets(config: Dict[str, Any]) -> List[Dict[str, str]]:
        ...
        for base in base_urls:
            ...
            fallback_endpoint = ""
            if TelemetryRepository._is_local_base(normalized_base) and endpoint_local:
                target_endpoint = endpoint_local
            elif TelemetryRepository._is_cloud_base(normalized_base) and endpoint_cloud:
