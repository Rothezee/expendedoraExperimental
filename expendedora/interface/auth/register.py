...
from expendedora.persistence.mysql.cashier_database import add_user
...
class RegisterWindow:
    ...
    def register(self):
        ...
        try:
            ...
            msg = AppController.format_db_error(exc) or "No se pudo registrar el usuario en la base remota."
