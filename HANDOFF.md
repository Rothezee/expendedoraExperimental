...
- Ajustes de pines operativos (motor/reversa/sensor en 12/10/8).
...
- Prueba de regresion guiada (1, 2, 5, 10 fichas) y verificacion de payload de telemetria.
- Endurecer tests automatizados en bridge para:
  - TOKEN con delta MCU.
  - dedupe de envio en `TOKEN/RUN_DONE`.
  - preservacion de global en logout.
- Revisar endpoint local que devuelve `500`.
